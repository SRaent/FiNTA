def Settings( **kwargs ):
  return {
          'flags': ['-std=c++14', '-isystem/usr/bin/../lib64/gcc/x86_64-pc-linux-gnu/9.3.0/../../../../include/c++/9.3.0', '-isystem/usr/bin/../lib64/gcc/x86_64-pc-linux-gnu/9.3.0/../../../../include/c++/9.3.0/x86_64-pc-linux-gnu', '-isystem/usr/bin/../lib64/gcc/x86_64-pc-linux-gnu/9.3.0/../../../../include/c++/9.3.0/backward', '-isystem/usr/local/include', '-isystem/usr/lib/clang/10.0.0/include', '-isystem/usr/include', '-x', 'c++', '-L', '/usr/lib/', '-stdlib=libstdc++', '-lstdc++',
